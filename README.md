...
WePlan 接受一句自然语言输入（如"今天下午带老婆孩子出去玩"），通过 7 个 AI Agent 协作，在 10 秒内生成 2-3 个完整的吃喝玩乐方案，用户确认后一键完成预约、购票、叫车等全部动作。
...
| 维度 | WePlan 的表现 |
|------|--------------|
| **创新性** | 7-Agent 协作 + Critic 循环 + 群体投票 + Agent Thinking 可视化 |
| **完整性** | 全链路闭环 + 100页文档 + 在线 Demo + GitHub 完整代码 |
| **应用效果** | 真实高德 API + MiniMax M2.7 实时推理 + 流式输出 + 6大场景 |
